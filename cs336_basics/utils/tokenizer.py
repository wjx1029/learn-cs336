...
# vocab_size = 10000
# data_path = os.path.join('..', 'data', 'TinyStoriesV2-GPT4', f'vs_{vocab_size}')
# tokenizer_10000 = BPETokenizer.from_files(os.path.join(data_path, 'vocab.csv'), os.path.join(data_path, 'merges.csv'), special_tokens)

# vocab_size = 32000
# data_path = os.path.join('..', 'data', 'TinyStoriesV2-GPT4', f'vs_{vocab_size}')
# tokenizer_32000 = BPETokenizer.from_files(os.path.join(data_path, 'vocab.csv'), os.path.join(data_path, 'merges.csv'), special_tokens)
...
if __name__ == "__main__":
    ...
    bpe_tokenizer = BPETokenizer.from_files(os.path.join(data_path, 'vocab.csv'), os.path.join(data_path, 'merges.csv'), special_tokens)
